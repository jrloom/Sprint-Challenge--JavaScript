...
*/
const animalNames = [];
zooAnimals.forEach(names => animalNames.push(`Name: ${names.animal_name}, Scientific: ${names.scientific_name}`));
...
const lowerPopulation = zooAnimals.filter(pops => `${pops.population <= 5}`);
